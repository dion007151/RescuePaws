  ...
  return (
    <div className="min-h-screen bg-[hsl(45,30%,98%)] p-6 lg:p-12 bg-paw-pattern overflow-x-hidden">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {/* Footer Branding */}
        <footer className="pt-16 pb-24 flex flex-col items-center text-center gap-4">
           <div className="w-12 h-1 px-4 bg-[hsl(155,15%,90%)] rounded-full mb-4 opacity-50" />
           ...
           <div className="flex items-center gap-4 mt-2">
              <span className="text-[9px] font-black uppercase tracking-widest text-[hsl(155,15%,60%)]">V.2.5.0 Production</span>
              <div className="w-1 h-1 bg-[hsl(15,80%,65%)] rounded-full" />
              <span className="text-[9px] font-black uppercase tracking-widest text-[hsl(155,15%,60%)]">Premium Rescue Hub</span>
           </div>
        </footer>
